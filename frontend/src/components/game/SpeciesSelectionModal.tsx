...
export const SpeciesSelectionModal: React.FC<SpeciesSelectionModalProps> = ({
  open,
  onClose,
}) => {
      ...
      <div className="bg-white rounded-lg p-6 max-w-2xl w-full mx-4 max-h-[80vh] overflow-y-auto">
        <div className="mb-4">
          ...
          <p className="text-gray-600">
            Select one species to begin your dungeon{" "}
            <strong>(FREE for your first species)</strong>. You can unlock
            additional species later using gold.
          </p>
        </div>
